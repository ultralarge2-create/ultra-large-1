...
export default function JobSeekerForm({ country }: { country: string }) {
    ...
    return (
        <div className="border-border/50 relative rounded-3xl border p-6 lg:col-span-3">
            <div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div><label className="block text-sm mb-1">Select country of your choice</label><select name="country" className="w-full px-3 py-2 border rounded-md" defaultValue={country}><option>Australia</option><option>Canada</option><option>USA</option><option>UK</option><option>Europe</option><option>Asia</option></select></div>
