            ...
            <div className="mx-auto max-w-6xl px-6">
                <div className="grid md:grid-cols-2 gap-12 lg:grid-cols-5 lg:gap-24">
                    <div className="lg:col-span-2">
                        <h2 className="text-4xl font-semibold lg:text-5xl">Job Seekers in Europe</h2>
                        <p className="mt-6">Find your dream job in Europe with our comprehensive support and guidance.</p>
